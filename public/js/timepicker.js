...
var content = $('<div class="timepicker">\
		<div v-show class="title">Please choose</div>\
			<div class="chose-all">\
				...
				<div class="text">\
					<div class="cell-4"><a class="js-hour-show" title="When selected"></a></div>\
					<div class="cell-2">:</div>\
					<div class="cell-4"><a class="js-minute-show" title="Selection point"></a></div>\
				</div>\
				<div class="handle">\
...
timepicker.bindEvent = function () {
	...
	thisTimePicker.hourShow.on('click',function() {
		...
		thisTimePicker.title.text('Please select an hour');
	});
	...
	thisTimePicker.minuteShow.on('click',function() {
		...
		thisTimePicker.title.text('Please select minutes');
	});
};
